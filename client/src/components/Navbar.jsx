...
const Navbar = () => {
  ...
  const {logout, isAuthenticated, userInfo} = useAppContext();
  ...
  return (
    <div className="sticky top-0 max-h-20 flex justify-between items-center h-[100px] shadow-md bg-navcol z-10">
      ...
      <div className="md:flex gap-12 hidden text-xl font-semibold">
        <NavLink to="/" className={({ isActive }) => (isActive ? "active" : "hover:underline")}>
          Home
        </NavLink>
        <NavLink to="/features" className={({ isActive }) => (isActive ? "active" : "hover:underline")}>
          Features
        </NavLink>
        <NavLink to="/project" className={({ isActive }) => (isActive ? "active" : "hover:underline")}>
          Projects
        </NavLink>
        <NavLink to="/contribute" className={({ isActive }) => (isActive ? "active" : "hover:underline")}>
          Contribute
        </NavLink>
        <NavLink to="/contactUs" className={({ isActive }) => (isActive ? "active" : "hover:underline")}>
          Contact Us
        </NavLink>
      </div>
      ...
      <div className="flex space-x-6 mr-10">
        ...
        {!isAuthenticated || !userInfo ? (
          ...
          <div className="flex items-center gap-2 cursor-pointer group relative">
            ...
            <img className="w-8 h-8 rounded-full" src={userInfo.imageUrl || "./upload_area.png"} alt="User Profile" />
            ...
            <div className="absolute top-0 right-0 pt-14 text-base font-medium text-gray-600 z-20 hidden group-hover:block">
              <div className="min-w-48 bg-stone-100 rounded flex flex-col gap-4 p-4">
                ...
                <p onClick={() => navigate("/change-password")} className="hover:text-black cursor-pointer">
                  Change Password
                </p>
                <p
                  onClick={logout}
